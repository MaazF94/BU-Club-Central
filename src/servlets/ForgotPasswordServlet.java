...
public class ForgotPasswordServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (callUserCheckEmailExists(request.getParameter("email"))) {
			...
			callEmailForgotPassword(request.getParameter("email"), user.getId_num(), user.getUsername());
...
request.getRequestDispatcher("/WEB-INF/jsp/ForgotPassword.jsp").forward(request, response);
	...
	public static void callEmailForgotPassword(String email, int id_num, String username) {
		...
		String content = "<!DOCTYPE html>\r\n" + 
				...
				"                        <p style=\"font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;\">" + "<b>" +  "Reset password here: </b> <a href= 'cs.ben.edu/bu-club-central/CreateNewPasswordServlet?id_num=" + id_num + "&username=" + username + "&email=" + email + "'>Reset My Password</a> </p>\r\n" + 
