...
/**
 * Servlet implementation class BMEmailsAdminServlet
 */
@WebServlet("/BMEmailsAdminServlet")
public class BMEmailsAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BMEmailsAdminServlet() {
        super();
...
response.sendRedirect("BoardMemberDashBoard");
	...
	public static void callEmailAdmin(String first_name, String last_name, String email, String message) {
		String subject = "Message by BU Club Central Board Member " + first_name + " " + last_name + "!";
