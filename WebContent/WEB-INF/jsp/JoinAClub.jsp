				...
				<div class="cell-sm-12">
					<div class="range range-xs-center">
						...
						<div
							...
							<!-- Footer brand-->
							<form id="prac" data-form-output="form-output-global"
								...
								<div class="form-group">
									<div class="input-group input-group-sm">
										<span class="input-group-addon input-group-addon-inverse"><span
											...
											id="fullname" placeholder="Your Full Name" type="text"
											name="fullname" data-constraints="@Required"
											class="form-control">
									</div>
								</div>
								<div class="form-group offset-top-20">
									<div class="input-group input-group-sm">
										<span class="input-group-addon input-group-addon-inverse"><span
											class="input-group-icon mdi mdi-account-outline"></span></span> <input
											id="ID" placeholder="Your BenU ID Number" type="text"
											name="ID" data-constraints="@Required" class="form-control">
									</div>
								</div>
								<div class="form-group offset-top-20">
									<div class="input-group input-group-sm">
										...
										</span> <input id="emailaddress" placeholder="Your Email Address"
											type="text" name="email" data-constraints="@Required"
											class="form-control">
									</div>
								</div>
								<label><input type="checkbox" name="club" value="AMSA" />
									AMSA</label><br> <label><input type="checkbox" name="club"
									value="BSU" />Black Student Union</label><br> <label><input
									type="checkbox" name="club" value="Computer Science Club" />Computer
									Science Club</label><br> <label><input type="checkbox"
									name="club" value="DentalClub" />Dental Club</label><br> <label><input
									type="checkbox" name="club" value="HSA" />Hindu Student
									Association</label><br> <label><input type="checkbox"
									name="club" value="MSA" />Muslim Student Association</label><br>
