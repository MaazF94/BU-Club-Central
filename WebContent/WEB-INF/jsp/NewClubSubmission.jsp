				...
				<div class="cell-sm-12">
					<div class="range range-xs-center">
						...
						<div
							...
							<!-- Footer brand-->
							<form id="myform" data-form-output="form-output-global"
								data-form-type="contact" method="post"
								class="text-left offset-top-30">
								<h1 style="color: white;">New Club</h1>
								<div class="form-group">
									<div class="input-group input-group-sm">
										<span class="input-group-addon input-group-addon-inverse"><i
											class="material-icons" style="font-size: 19px">people_outline</i></span>
								...
								<div class="form-group offset-top-20">
									<div class="input-group input-group-sm">
										<span class="input-group-addon input-group-addon-inverse"><span
											class="input-group-icon mdi mdi-account-outline"></span></span> <input
											id="advisorname" placeholder="Your Advisor's Name"
											type="text" name="advisorname" data-constraints="@Required"
											class="form-control">
									</div>
								</div>
								<div class="form-group offset-top-20">
									<div class="input-group input-group-sm">
										...
										<textarea style="height: 100px;" id="comment"
											placeholder="Tell Us About Your Club Idea Here..."
											type="text" name="comment" data-constraints="@Required"
