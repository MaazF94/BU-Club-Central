  ...
  <div class="modal fade" id="createModal" role="dialog">
    <div class="modal-dialog" style="top:25%;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="POST" action="CreatEventServlet">
          	<div class="form-group">
            ...
            <div class="form-group">
              ...
              <input name="date" type="text" class="form-control" id="id" placeholder="Enter ID">
            </div>
            
            <div class="form-group">
              <label for="id"><span class="glyphicon glyphicon-user"></span> Event Time</label>
              <input name="time" type="text" class="form-control" id="id" placeholder="Enter the time of the event">
            </div>
            
            <div class="form-group">
              <label for="id"><span class="glyphicon glyphicon-user"></span> Event Length</label>
              <input name="length_of_event" type="text" class="form-control" id="id" placeholder="Enter length of event in hours">
            </div>
            
            <div class="form-group">
              <label for="id"><span class="glyphicon glyphicon-user"></span> Expected attendance</label>
              <input name="expected_count" type="text" class="form-control" id="id" placeholder="Expected Number of people coming ">
            </div>
            
            <div class="form-group">
              <label for="id"><span class="glyphicon glyphicon-user"></span> Type of Event</label>
              <input name="type_of_event" type="text" class="form-control" id="id" placeholder="Charity, Fundraiser, Meeting, ... etc">
            </div>
