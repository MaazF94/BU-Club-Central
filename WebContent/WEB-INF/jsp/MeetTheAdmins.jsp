	...
	<div class="page text-center">
							...
							<div class="range range-xs-center">
								<div class="cell-lg-12">
									<div data-caption-animate="fadeInUp" data-caption-delay="300"
										...
										style="color: red">Meet The Admins</div>
								</div>
								<div class="cell-lg-9 offset-top-20">
									...
									<h6 style="font-size: 24px;">Take a look below to learn
		...
		<div data-on="false" data-md-on="true"
			...
			<div class="shell">
				...
				<img src="img\danny.jpg" alt="Danny Turano"
					style="width: 225px; height: 228px;">

				<h6 class="range">Hi, my name is Danny Turano and I'm the
					Director of Student Life. Hi, my name is Danny Turano and I'm the
					Director of Student Life. Hi, my name is Danny Turano and I'm the
					Director of Student Life. Hi, my name is Danny Turano and I'm the
					Director of Student Life.</h6>
			</div>
		</div>
		...
		<div data-on="false" data-md-on="true"
			...
			<div style="padding: 30px;" class="shell">
				...
				<img src="img\JoanHenehan.jpg" alt="Joan Henehan"
					style="width: 225px; height: 228px;">
				<h6 class="range">Hi, my name is Joan Henehan and I am the
					Director of Student Engagement and Leadership Development. Hi, my
					name is Joan Henehan and I am the Director of Student Engagement
					and Leadership Development. Hi, my name is Joan Henehan and I am
					the Director of Student Engagement and Leadership Development. Hi,
					my name is Joan Henehan and I am the Director of Student Engagement
					and Leadership Development.</h6>
			</div>
		</div>
