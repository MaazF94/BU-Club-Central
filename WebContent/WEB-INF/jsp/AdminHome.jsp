											...
											<table id="myTable" class="table table-hover sortable">
												<thead>
													<tr>
														...
														<th>ID Number</th>
														<th>Email</th>
														<th><input value="Set Roles"
															onclick="return confirm('Please be aware, roles will be processed and set in the order as they appear.');"
															type="submit" id="submit-form" class="btn btn-primary" /><br>Role
															ID</th>
												...
												<tbody
													...
													<tr id=<%=userListIndex%>>
														...
														<td><select name="role_id"
															onchange="document.getElementById('<%=userListIndex%>').bgColor = '#00FF00'; document.getElementById('<%=linkCount%>').style.display = 'inline'">
															...
															data-toggle="modal" href="#setRolesModal">Choose Club</a>
